...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = 'Sabia que dirias que si I love u';
...
document.getElementById('noBtn').addEventListener('click', function() {
    ...
    switch (noButtonState) {
        ...
        case 3:
            ...
            document.getElementById('noBtn').innerHTML = '¿Completamente segura?';
        ...
        case 5:
            ...
            document.getElementById('noBtn').innerHTML = 'DILO YAA!!';
